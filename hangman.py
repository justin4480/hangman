...
class Hangman(object):
    ...
    def get_secret_grid(self) -> str:
        return ' '.join([letter if letter.lower() not in self.avalible_guess else '_' for letter in self.secret_word])

    def get_remaining_letters(self) -> str:
        return ' '.join([letter if letter in self.avalible_guess else '_' for letter in self.alphabet])
    ...
    def check_for_win(self) -> bool:
        return len(set(self.avalible_guess).intersection(set(self.secret_word.lower()))) == 0
...
def main():
    while True:
        movies = [
            "Alice in Wonderland","Toy Story 3","Cars 2","Winnie the Pooh","The Muppets",
            "Wreck-It Ralph","Monsters University","Frozen","Big Hero 6","Inside Out","The Good Dinosaur",
            "Moana","Beauty and the Beast","Coco","Incredibles 2","Aladdin","The Lion King"]
